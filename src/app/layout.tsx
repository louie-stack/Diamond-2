...
import { Alfa_Slab_One, Bangers, Special_Elite, Barlow_Condensed } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${slab.variable} ${comic.variable} ${type.variable} ${cond.variable}`}>
      <body>{children}</body>
    </html>
  );
}
